$PBExportHeader$w_inh402w01_l1_winandmenu.srw
forward
...
type cb_clear from commandbutton within w_inh402w01_l1_winandmenu
end type
type cb_close from commandbutton within w_inh402w01_l1_winandmenu
end type
type mle_output from multilineedit within w_inh402w01_l1_winandmenu
end type
type mle_view from multilineedit within w_inh402w01_l1_winandmenu
end type
type gb_3 from groupbox within w_inh402w01_l1_winandmenu
end type
type gb_5 from groupbox within w_inh402w01_l1_winandmenu
end type
type mle_describe from multilineedit within w_inh402w01_l1_winandmenu
end type
type gb_1 from groupbox within w_inh402w01_l1_winandmenu
end type
type gb_2 from groupbox within w_inh402w01_l1_winandmenu
end type
type cb_cotviewresult from commandbutton within w_inh402w01_l1_winandmenu
end type
type cb_cotautorun from commandbutton within w_inh402w01_l1_winandmenu
end type
end forward
...
string title = "Multilayer Window and Menu"
string menuname = "m_inh402_l2_no1"
...
global w_inh402w01_l1_winandmenu w_inh402w01_l1_winandmenu
...
mle_describe.text += "2.Appeon Menu : "
mle_describe.text +=  lm_this.Classname() + "~r~n" 
mle_describe.text += "3.Testing Purpose : " + This.Title// This must include
mle_describe.text += "~r~n"
mle_describe.text += "4.Operation Step : ~r~n" // Optional
mle_describe.text += ""
mle_describe.text += "5.Object Declare : ~r~n" // Optional
Return
end subroutine
...
/////////////////////////////////////////////////////////////////////
long			ll_pos
String 		ls_item, ls_descript, ls_menuName
menu			lm_this
...
lm_this = This.Menuid
ls_menuName = lower(lm_this.ClassName())

String ls_original[4]
CHOOSE CASE ls_menuName
	CASE 'm_inh402_l1_no1'
		If ab_execute Then
			//Output 'm_inh402_l1_no1' Instance Variables.
			//is_L1
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)
			ls_original[1]= m_inh402_l1_no1.is_L1 
			Wf_Output('First Get  : is_L1 = ~"' + m_inh402_l1_no1.is_L1 + '~"', False)
			m_inh402_l1_no1.is_L1 = 'Set L1'
			Wf_Output('Second Get : is_L1 = ~"' + m_inh402_l1_no1.is_L1 + '~"', False)
	
			/////////////////////////////////////////////////////////////////////////
			//author:lujianhua
			//Add Code: restore the original value¡£
			///////////////
			 m_inh402_l1_no1.is_L1 =ls_original[1]
			///Array Length=1
			//////////////////////////////////////////////////////////////////////////
	Else
			wf_scriptview("//Output 'm_inh402_l1_no1' Instance Variables.                            ")
			wf_scriptview("//is_L1                                                                   ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)                                ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)                           ")
			wf_scriptview("Wf_Output('First Get  : is_L1 = ~"' + m_inh402_l1_no1.is_L1 + '~"', False)")
			wf_scriptview("m_inh402_l1_no1.is_L1 = 'Set L1'                                          ")
			wf_scriptview("Wf_Output('Second Get : is_L1 = ~"' + m_inh402_l1_no1.is_L1 + '~"', False)")
			
		End If
	CASE 'm_inh402_l1_no2'
		If ab_execute Then
			//Output 'm_inh402_l1_no2' Instance Variables.
			//is_L1_No2
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)
			ls_original[1]= m_inh402_l1_no2.is_L1_No2 
			Wf_Output('First Get  : is_L1_No2 = ~"' + m_inh402_l1_no2.is_L1_No2 + '~"', False)
			m_inh402_l1_no2.is_L1_No2 = 'Set L1 No2'
			Wf_Output('Second Get : is_L1_No2 = ~"' + m_inh402_l1_no2.is_L1_No2 + '~"', False)
		
			/////////////////////////////////////////////////////////////////////////
			//author:lujianhua
			//Add Code: restore the original value¡£
			///////////////
			 m_inh402_l1_no2.is_L1_No2 =ls_original[1]
			///Array Length=1
			//////////////////////////////////////////////////////////////////////////
Else
			wf_scriptview("//Output 'm_inh402_l1_no2' Instance Variables.                                    ")
			wf_scriptview("//is_L1_No2                                                                       ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)                                        ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)                                   ")
			wf_scriptview("Wf_Output('First Get  : is_L1_No2 = ~"' + m_inh402_l1_no2.is_L1_No2 + '~"', False)")
			wf_scriptview("m_inh402_l1_no2.is_L1_No2 = 'Set L1 No2'                                          ")
			wf_scriptview("Wf_Output('Second Get : is_L1_No2 = ~"' + m_inh402_l1_no2.is_L1_No2 + '~"', False)")

		End If
	CASE 'm_inh402_l2_no1'
		If ab_execute Then
			//Output 'm_inh402_l2_no1' Instance Variables.
			//is_L1 (Level 1)
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)
			ls_original[1]= m_inh402_l2_no1.is_L1 
			Wf_Output('First Get  : is_L1 = ~"' + m_inh402_l2_no1.is_L1 + '~"', False)
			m_inh402_l2_no1.is_L1 = 'Set L1'
			Wf_Output('Second Get : is_L1 = ~"' + m_inh402_l2_no1.is_L1 + '~"', False)
			//is_L2 (Level 2)
			ls_original[2]= m_inh402_l2_no1.is_L2 
			Wf_Output('First Get  : is_L2 = ~"' + m_inh402_l2_no1.is_L2 + '~"', False)
			m_inh402_l2_no1.is_L2 = 'Set L2'
			Wf_Output('Second Get : is_L2 = ~"' + m_inh402_l2_no1.is_L2 + '~"', False)
		
			/////////////////////////////////////////////////////////////////////////
			//author:lujianhua
			//Add Code: restore the original value¡£
			///////////////
			 m_inh402_l2_no1.is_L1 =ls_original[1]
			 m_inh402_l2_no1.is_L2 =ls_original[2]
			///Array Length=2
			//////////////////////////////////////////////////////////////////////////
Else
			wf_scriptview("//Output 'm_inh402_l2_no1' Instance Variables.                            ")
			wf_scriptview("//is_L1 (Level 1)                                                         ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)                                ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)                           ")
			wf_scriptview("Wf_Output('First Get  : is_L1 = ~"' + m_inh402_l2_no1.is_L1 + '~"', False)")
			wf_scriptview("m_inh402_l2_no1.is_L1 = 'Set L1'                                          ")
			wf_scriptview("Wf_Output('Second Get : is_L1 = ~"' + m_inh402_l2_no1.is_L1 + '~"', False)")
			wf_scriptview("//is_L2 (Level 2)                                                         ")
			wf_scriptview("Wf_Output('First Get  : is_L2 = ~"' + m_inh402_l2_no1.is_L2 + '~"', False)")
			wf_scriptview("m_inh402_l2_no1.is_L2 = 'Set L2'                                          ")
			wf_scriptview("Wf_Output('Second Get : is_L2 = ~"' + m_inh402_l2_no1.is_L2 + '~"', False)")
			
		End If
		
	CASE 'm_inh402_l3_no1'
		If ab_execute Then
			//Output 'm_inh402_l3_no1' Instance Variables.
			//is_L1 (Level 1)
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)
			ls_original[1]= m_inh402_l3_no1.is_L1 
			Wf_Output('First Get  : is_L1 = ~"' + m_inh402_l3_no1.is_L1 + '~"', False)
			m_inh402_l3_no1.is_L1 = 'Set L1'
			Wf_Output('Second Get : is_L1 = ~"' + m_inh402_l3_no1.is_L1 + '~"', False)
			//is_L2 (Level 2)
			ls_original[2]= m_inh402_l3_no1.is_L2 
			Wf_Output('First Get  : is_L2 = ~"' + m_inh402_l3_no1.is_L2 + '~"', False)
			m_inh402_l3_no1.is_L2 = 'Set L2'
			Wf_Output('Second Get : is_L2 = ~"' + m_inh402_l3_no1.is_L2 + '~"', False)
			//is_L3 (Level 3)
			ls_original[3]= m_inh402_l3_no1.is_L3 
			Wf_Output('First Get  : is_L3 = ~"' + m_inh402_l3_no1.is_L3 + '~"', False)
			m_inh402_l3_no1.is_L3 = 'Set L3'
			Wf_Output('Second Get : is_L3 = ~"' + m_inh402_l3_no1.is_L3 + '~"', False)
		
			/////////////////////////////////////////////////////////////////////////
			//author:lujianhua
			//Add Code: restore the original value¡£
			///////////////
			 m_inh402_l3_no1.is_L1 =ls_original[1]
			 m_inh402_l3_no1.is_L2 =ls_original[2]
			 m_inh402_l3_no1.is_L3 =ls_original[3]
			///Array Length=3
			//////////////////////////////////////////////////////////////////////////
Else
			wf_scriptview("//Output 'm_inh402_l3_no1' Instance Variables.                            ")
			wf_scriptview("//is_L1 (Level 1)                                                         ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)                                ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)                           ")
			wf_scriptview("Wf_Output('First Get  : is_L1 = ~"' + m_inh402_l3_no1.is_L1 + '~"', False)")
			wf_scriptview("m_inh402_l3_no1.is_L1 = 'Set L1'                                          ")
			wf_scriptview("Wf_Output('Second Get : is_L1 = ~"' + m_inh402_l3_no1.is_L1 + '~"', False)")
			wf_scriptview("//is_L2 (Level 2)                                                         ")
			wf_scriptview("Wf_Output('First Get  : is_L2 = ~"' + m_inh402_l3_no1.is_L2 + '~"', False)")
			wf_scriptview("m_inh402_l3_no1.is_L2 = 'Set L2'                                          ")
			wf_scriptview("Wf_Output('Second Get : is_L2 = ~"' + m_inh402_l3_no1.is_L2 + '~"', False)")
			wf_scriptview("//is_L3 (Level 3)                                                         ")
			wf_scriptview("Wf_Output('First Get  : is_L3 = ~"' + m_inh402_l3_no1.is_L3 + '~"', False)")
			wf_scriptview("m_inh402_l3_no1.is_L3 = 'Set L3'                                          ")
			wf_scriptview("Wf_Output('Second Get : is_L3 = ~"' + m_inh402_l3_no1.is_L3 + '~"', False)")
			
		End If
	CASE 'm_inh402_l4_no1'
		If ab_execute Then
			//Output 'm_inh402_l4_no1' Instance Variables.
			//is_L1 (Level 1)
			Wf_Output('Test Point : ' + ls_item, True)
			Wf_Output('Describe   : ' + ls_descript, False)
			ls_original[1]= m_inh402_l4_no1.is_L1 
			Wf_Output('First Get  : is_L1 = ~"' + m_inh402_l4_no1.is_L1 + '~"', False)
			m_inh402_l4_no1.is_L1 = 'Set L1'
			Wf_Output('Second Get : is_L1 = ~"' + m_inh402_l4_no1.is_L1 + '~"', False)
			//is_L2 (Level 2)
			ls_original[2]= m_inh402_l4_no1.is_L2 
			Wf_Output('First Get  : is_L2 = ~"' + m_inh402_l4_no1.is_L2 + '~"', False)
			m_inh402_l4_no1.is_L2 = 'Set L2'
			Wf_Output('Second Get : is_L2 = ~"' + m_inh402_l4_no1.is_L2 + '~"', False)
			//is_L3 (Level 3)
			ls_original[3]= m_inh402_l4_no1.is_L3 
			Wf_Output('First Get  : is_L3 = ~"' + m_inh402_l4_no1.is_L3 + '~"', False)
			m_inh402_l4_no1.is_L3 = 'Set L3'
			Wf_Output('Second Get : is_L3 = ~"' + m_inh402_l4_no1.is_L3 + '~"', False)
			//is_L4 (Level 4)
			ls_original[4]= m_inh402_l4_no1.is_L4 
			Wf_Output('First Get  : is_L4 = ~"' + m_inh402_l4_no1.is_L4 + '~"', False)
			m_inh402_l4_no1.is_L4 = 'Set L4'
			Wf_Output('Second Get : is_L4 = ~"' + m_inh402_l4_no1.is_L4 + '~"', False)
		
			/////////////////////////////////////////////////////////////////////////
			//author:lujianhua
			//Add Code: restore the original value¡£
			///////////////
			 m_inh402_l4_no1.is_L1 =ls_original[1]
			 m_inh402_l4_no1.is_L2 =ls_original[2]
			 m_inh402_l4_no1.is_L3 =ls_original[3]
			 m_inh402_l4_no1.is_L4 =ls_original[4]
			///Array Length=4
			//////////////////////////////////////////////////////////////////////////
Else
			wf_scriptview("//Output 'm_inh402_l4_no1' Instance Variables.                            ")
			wf_scriptview("//is_L1 (Level 1)                                                         ")
			wf_scriptview("Wf_Output('Test Point : ' + ls_item, True)                                ")
			wf_scriptview("Wf_Output('Describe   : ' + ls_descript, False)                           ")
			wf_scriptview("Wf_Output('First Get  : is_L1 = ~"' + m_inh402_l4_no1.is_L1 + '~"', False)")
			wf_scriptview("m_inh402_l4_no1.is_L1 = 'Set L1'                                          ")
			wf_scriptview("Wf_Output('Second Get : is_L1 = ~"' + m_inh402_l4_no1.is_L1 + '~"', False)")
			wf_scriptview("//is_L2 (Level 2)                                                         ")
			wf_scriptview("Wf_Output('First Get  : is_L2 = ~"' + m_inh402_l4_no1.is_L2 + '~"', False)")
			wf_scriptview("m_inh402_l4_no1.is_L2 = 'Set L2'                                          ")
			wf_scriptview("Wf_Output('Second Get : is_L2 = ~"' + m_inh402_l4_no1.is_L2 + '~"', False)")
			wf_scriptview("//is_L3 (Level 3)                                                         ")
			wf_scriptview("Wf_Output('First Get  : is_L3 = ~"' + m_inh402_l4_no1.is_L3 + '~"', False)")
			wf_scriptview("m_inh402_l4_no1.is_L3 = 'Set L3'                                          ")
			wf_scriptview("Wf_Output('Second Get : is_L3 = ~"' + m_inh402_l4_no1.is_L3 + '~"', False)")
			wf_scriptview("//is_L4 (Level 4)                                                         ")
			wf_scriptview("Wf_Output('First Get  : is_L4 = ~"' + m_inh402_l4_no1.is_L4 + '~"', False)")
			wf_scriptview("m_inh402_l4_no1.is_L4 = 'Set L4'                                          ")
			wf_scriptview("Wf_Output('Second Get : is_L4 = ~"' + m_inh402_l4_no1.is_L4 + '~"', False)")
...
lm_this = This.Menuid
lb_items.additem("INH402W" + mid(This.ClassName(), 10, 2)  + "P001: Calling Menu (" + lm_this.ClassName() + ") Instance Variables")
end subroutine
