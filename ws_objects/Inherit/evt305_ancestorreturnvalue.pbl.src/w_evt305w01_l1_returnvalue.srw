$PBExportHeader$w_evt305w01_l1_returnvalue.srw
forward
global type w_evt305w01_l1_returnvalue from window
end type
type cb_2 from commandbutton within w_evt305w01_l1_returnvalue
end type
type cb_3 from commandbutton within w_evt305w01_l1_returnvalue
end type
type cb_clear from commandbutton within w_evt305w01_l1_returnvalue
end type
type cb_execute from commandbutton within w_evt305w01_l1_returnvalue
end type
type cb_close from commandbutton within w_evt305w01_l1_returnvalue
end type
type mle_output from multilineedit within w_evt305w01_l1_returnvalue
end type
type mle_view from multilineedit within w_evt305w01_l1_returnvalue
end type
type lb_items from listbox within w_evt305w01_l1_returnvalue
end type
type gb_3 from groupbox within w_evt305w01_l1_returnvalue
end type
type gb_4 from groupbox within w_evt305w01_l1_returnvalue
end type
type gb_5 from groupbox within w_evt305w01_l1_returnvalue
end type
type mle_describe from multilineedit within w_evt305w01_l1_returnvalue
end type
type gb_2 from groupbox within w_evt305w01_l1_returnvalue
end type
type str_string from structure within w_evt305w01_l1_returnvalue
end type
end forward
...
string title = "Ancestor Event Return Value"
...
string icon = "AppIcon!"
boolean center = true
event type string ue_event_1 ( )
event type string ue_event_2 ( )
event ue_runall ( )
cb_2 cb_2
cb_3 cb_3
cb_clear cb_clear
...
global w_evt305w01_l1_returnvalue w_evt305w01_l1_returnvalue
...
event type string ue_event_1();Return 'Call w_evt305W01_l1_returnvalue.ue_event_1() Success'
end event

event type string ue_event_2();Return 'Call w_evt305W01_l1_returnvalue.ue_event_2() Success'
end event
...
mle_describe.text += "Ancestor Event Return Value~r~n"
...
on w_evt305w01_l1_returnvalue.create
...
on w_evt305w01_l1_returnvalue.destroy
destroy(this.cb_2)
destroy(this.cb_3)
