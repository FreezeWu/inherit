$PBExportHeader$evt305_ancestorreturnvalue.sra
$PBExportComments$Generated Application Object
forward
global type evt305_ancestorreturnvalue from application
end type
...
string  gs_WinName[] = {"w_evt305w02_l2_returnvalue"}
//END_GLOBALVAR
end variables

global type evt305_ancestorreturnvalue from application
string appname = "evt305_ancestorreturnvalue"
event ue_cotopen ( string as_commandline )
end type
global evt305_ancestorreturnvalue evt305_ancestorreturnvalue
...
on evt305_ancestorreturnvalue.create
appname="evt305_ancestorreturnvalue"
...
on evt305_ancestorreturnvalue.destroy
destroy(sqlca)
destroy(sqlda)
destroy(sqlsa)
destroy(error)
...
//Test Content: Ancestor Event Return Value
//Designer: 	 XuYi 
//Date:     	 2003-04-25
//Other:			
