$PBExportHeader$evt302_overrideextend.sra
$PBExportComments$Generated Application Object
forward
global type evt302_overrideextend from application
end type
...
string  gs_WinName[] = {"w_evt302w03_l3_er1"}
//END_GLOBALVAR
end variables

global type evt302_overrideextend from application
string appname = "evt302_overrideextend"
event ue_cotopen ( string as_commandline )
end type
global evt302_overrideextend evt302_overrideextend
...
on evt302_overrideextend.create
appname="evt302_overrideextend"
...
on evt302_overrideextend.destroy
destroy(sqlca)
destroy(sqlda)
destroy(sqlsa)
destroy(error)
...
//Test Content: Event OverLoad And Override  
//Designer: 	 XuYi 
//Date:     	 2003-04-24
//Other:			
