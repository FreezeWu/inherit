$PBExportHeader$evt304_callancestorevent.sra
$PBExportComments$Generated Application Object
forward
global type evt304_callancestorevent from application
end type
...
string  gs_WinName[] = {"w_evt304w03_l3_callevent"}
//END_GLOBALVAR
end variables

global type evt304_callancestorevent from application
string appname = "evt304_callancestorevent"
event ue_cotopen ( string as_commandline )
end type
global evt304_callancestorevent evt304_callancestorevent
...
on evt304_callancestorevent.create
appname="evt304_callancestorevent"
...
on evt304_callancestorevent.destroy
destroy(sqlca)
destroy(sqlda)
destroy(sqlsa)
destroy(error)
...
//Test Content: Call Supper Event Thing
//Designer: 	 XuYi 
//Date:     	 2003-04-25
//Other:			
