$PBExportHeader$evt303_ancestoreventsyntax.sra
$PBExportComments$Generated Application Object
forward
global type evt303_ancestoreventsyntax from application
end type
...
global variables
String	gs_call = 'Error'

String	gs_point = 'Null'
...
string  gs_WinName[] = {"w_evt303w02_l2_callsyntax","w_evt303w03_l2_callsyntax"}
//END_GLOBALVAR
end variables

global type evt303_ancestoreventsyntax from application
string appname = "evt303_ancestoreventsyntax"
event ue_cotopen ( string as_commandline )
end type
global evt303_ancestoreventsyntax evt303_ancestoreventsyntax
...
on evt303_ancestoreventsyntax.create
appname="evt303_ancestoreventsyntax"
...
on evt303_ancestoreventsyntax.destroy
destroy(sqlca)
destroy(sqlda)
destroy(sqlsa)
destroy(error)
...
event open;//Appeon Test Case for Appeon 2.5
//Test Content: Call Supper Event Syntax
//Designer: 	 XuYi 
//Date:     	 2003-04-24
//Other:			
