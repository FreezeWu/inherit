$PBExportHeader$w_evt303w01_l1_callsyntax.srw
forward
global type w_evt303w01_l1_callsyntax from window
end type
type cb_2 from commandbutton within w_evt303w01_l1_callsyntax
end type
type cb_3 from commandbutton within w_evt303w01_l1_callsyntax
end type
type cb_clear from commandbutton within w_evt303w01_l1_callsyntax
end type
type cb_execute from commandbutton within w_evt303w01_l1_callsyntax
end type
type cb_close from commandbutton within w_evt303w01_l1_callsyntax
end type
type mle_output from multilineedit within w_evt303w01_l1_callsyntax
end type
type mle_view from multilineedit within w_evt303w01_l1_callsyntax
end type
type lb_items from listbox within w_evt303w01_l1_callsyntax
end type
type gb_3 from groupbox within w_evt303w01_l1_callsyntax
end type
type gb_4 from groupbox within w_evt303w01_l1_callsyntax
end type
type gb_5 from groupbox within w_evt303w01_l1_callsyntax
end type
type mle_describe from multilineedit within w_evt303w01_l1_callsyntax
end type
type gb_2 from groupbox within w_evt303w01_l1_callsyntax
end type
type str_string from structure within w_evt303w01_l1_callsyntax
end type
end forward
...
string title = "Call Ancestor Event Syntax"
...
global w_evt303w01_l1_callsyntax w_evt303w01_l1_callsyntax
...
event ue_event();gs_call = 'Call Window Event w_evt303W01_l1_callsyntax.ue_event()(global var gs_point = ' + gs_point + ')'
...
on w_evt303w01_l1_callsyntax.create
...
on w_evt303w01_l1_callsyntax.destroy
destroy(this.cb_2)
destroy(this.cb_3)
