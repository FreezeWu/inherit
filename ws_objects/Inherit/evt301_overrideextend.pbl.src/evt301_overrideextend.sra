$PBExportHeader$evt301_overrideextend.sra
$PBExportComments$Generated Application Object
forward
global type evt301_overrideextend from application
end type
...
string  gs_WinName[] = {"w_evt301w03_l3_er1"}
//END_GLOBALVAR
end variables

global type evt301_overrideextend from application
string appname = "evt301_overrideextend"
event ue_cotopen ( string as_commandline )
end type
global evt301_overrideextend evt301_overrideextend
...
on evt301_overrideextend.create
appname="evt301_overrideextend"
...
on evt301_overrideextend.destroy
destroy(sqlca)
destroy(sqlda)
destroy(sqlsa)
destroy(error)
