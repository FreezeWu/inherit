$PBExportHeader$w_evt301w01_l1_er1.srw
forward
global type w_evt301w01_l1_er1 from window
end type
type cb_2 from commandbutton within w_evt301w01_l1_er1
end type
type cb_3 from commandbutton within w_evt301w01_l1_er1
end type
type cb_clear from commandbutton within w_evt301w01_l1_er1
end type
type cb_execute from commandbutton within w_evt301w01_l1_er1
end type
type cb_close from commandbutton within w_evt301w01_l1_er1
end type
type mle_output from multilineedit within w_evt301w01_l1_er1
end type
type mle_view from multilineedit within w_evt301w01_l1_er1
end type
type lb_items from listbox within w_evt301w01_l1_er1
end type
type gb_3 from groupbox within w_evt301w01_l1_er1
end type
type gb_4 from groupbox within w_evt301w01_l1_er1
end type
type gb_5 from groupbox within w_evt301w01_l1_er1
end type
type mle_describe from multilineedit within w_evt301w01_l1_er1
end type
type gb_2 from groupbox within w_evt301w01_l1_er1
end type
type str_string from structure within w_evt301w01_l1_er1
end type
end forward
...
string title = "Event OverLoad And Override 1"
...
global w_evt301w01_l1_er1 w_evt301w01_l1_er1
...
event ue_event_e1r23();wf_output('Information:   Call Window Event w_evt301W01_l1_er1.ue_event_e1r23()', False)

end event

event ue_event_e1r2();wf_output('Information:   Call Window Event w_evt301W01_l1_er1.ue_event_e1r2()', False)

end event

event ue_event_e13r2();wf_output('Information:   Call Window Event w_evt301W01_l1_er1.ue_event_e13r2()', False)

end event

event ue_event_e1r3();wf_output('Information:   Call Window Event w_evt301W01_l1_er1.ue_event_e1r3()', False)

end event

event ue_event_e1();wf_output('Information:   Call Window Event w_evt301W01_l1_er1.ue_event_e1()', False)

end event

event ue_event_e13();wf_output('Information:   Call Window Event w_evt301W01_l1_er1.ue_event_e13()', False)

end event

event ue_event_e12r3();wf_output('Information:   Call Window Event w_evt301W01_l1_er1.ue_event_e12r3()', False)

end event

event ue_event_e12();wf_output('Information:   Call Window Event w_evt301W01_l1_er1.ue_event_e12()', False)

end event

event ue_event_e123();wf_output('Information:   Call Window Event w_evt301W01_l1_er1.ue_event_e123()', False)
...
mle_describe.text += "Event OverLoad And Override 1~r~n"
